        ...
        func handlePan(sender: UIPanGestureRecognizer){
            ...
            if (sender.state == .began || sender.state == .changed){
                ...
                if let view = sender.view,parent.scalePosition != .zero{
                    ...
                    parent.offset = CGPoint(x: parent.offset.x + translation.x - currentXOffset, y: parent.offset.y + translation.y - currentYOffset)
//                    parent.offset = translation
                    currentXOffset = sender.translation(in: view).x
                    currentYOffset = sender.translation(in: view).y
                }
...
//            }
        ...
        func handlePinch(sender: UIPinchGestureRecognizer){
            ...
            if sender.state == .began || sender.state == .changed{
                // setting scale..
                // removing added 1...
                parent.scale += (sender.scale - 1 - currentZoom)
                let proposedZoom = sender.scale - 1
